...
class Coder(object):
    def __init__(self, TEAM, CPP_DEVELOPER, requirement, model='gpt-3.5-turbo-0301', majority=1, max_tokens=512,
        ...
        system_message = construct_system_message(requirement, CPP_DEVELOPER, TEAM)
